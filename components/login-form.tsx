...
const LoginForm = ({ onLogin, onSwitchToSignup, onGoogleLogin }: LoginFormProps) => {
  ...
  return (
    <div className="py-8 px-4 sm:px-6 md:px-8 max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full bg-orange-500 text-white py-2 rounded-lg font-medium hover:bg-orange-600 transition-colors relative"
          disabled={isLoading || isGoogleLoading}
        >
          {isLoading ? (
      ...
      <div className="mt-6">
        ...
        <button
          ...
          className="mt-4 w-full flex items-center justify-center gap-3 bg-white border border-gray-300 rounded-lg py-2 px-4 text-gray-700 hover:bg-gray-50 transition-colors relative"
          disabled={isLoading || isGoogleLoading}
        >
          {isGoogleLoading ? (
            <div className="flex items-center justify-center">
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-600">
          ...
          <button className="text-orange-600 font-medium" onClick={onSwitchToSignup}>
            Sign up
          </button>
        </p>
      </div>
